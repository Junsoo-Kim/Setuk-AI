...
class AgentInstructionTests(unittest.TestCase):
    ...
    def test_all_pipeline_files_exist(self):
        expected = {
            ...
            "01c_activity_report_ingestion.md",
            "01d_activity_classification.md",
            "01e_physics_report_ingestion.md",
            "01f_common_education_drafting.md",
            "02_data_structuring.md",
            "03_drafting.md",
            "03c_activity_drafting.md",
            "03e_physics_drafting.md",
            "04_evaluation.md",
        }
    ...
    def test_report_ingestion_uses_portable_utf8_extractor(self):
        ...
        self.assertIn("후보가 둘 이상이면 문서를 열지 말고", self.ingestion)
